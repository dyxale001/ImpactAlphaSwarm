export default function AdminDashboardSkeleton() {
  return (
    <>
      <div className="relative motion-safe:animate-pulse space-y-6 p-4 sm:p-6 lg:p-8 min-h-screen bg-brand-bg text-brand-fg">
        <div className="max-w-6xl mx-auto space-y-8">
          <div className="bg-brand-bg/60 backdrop-blur-xl rounded-lg p-4 -mx-4 px-4">
            <div className="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-4">
              <div className="space-y-3">
                <div className="h-8 w-52 rounded bg-brand-border/40" />
          ...
          <div className="h-12 rounded-brand bg-background border border-brand-border" />
                    ...
                    <tr key={idx} className="hover:bg-brand-bg/30">
                      <td className="p-5">
                        <div className="space-y-3">
                          ...
                          <div className="h-3 w-36 rounded bg-brand-border/30" />
                          <div className="h-6 w-24 rounded-full bg-brand-border/30" />
                        </div>
                      </td>
                      <td className="p-5">
                        <div className="h-6 w-28 rounded-full bg-brand-border/30" />
                      </td>
                      <td className="p-5">
                        <div className="space-y-2">
                          <div className="h-3 w-40 rounded bg-brand-border/30" />
                          <div className="h-3 w-32 rounded bg-brand-border/30" />
                        </div>
                      </td>
                      <td className="p-5">
                        <div className="flex items-center justify-end gap-2">
                          <div className="h-8 w-16 rounded-lg bg-brand-border/30" />
                          <div className="h-8 w-24 rounded-lg bg-brand-border/30" />
                          <div className="h-8 w-24 rounded-lg bg-brand-border/30" />
