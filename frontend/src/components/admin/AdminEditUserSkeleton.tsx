export default function AdminEditUserSkeleton() {
  return (
    <>
      <div className="px-4 pt-6 text-sm font-semibold text-brand-fg sm:px-6 lg:px-8">
        Loading user details...
      </div>
      <div className="relative motion-safe:animate-pulse p-4 sm:p-6 lg:p-8 min-h-screen bg-brand-bg text-brand-fg">
