export default function AdminLearningCategoriesSkeleton() {
  return (
    <>
      <div className="relative motion-safe:animate-pulse space-y-8 p-4 sm:p-6 lg:p-8 min-h-screen bg-brand-bg text-brand-fg">
                  ...
                  <tbody className="divide-y divide-brand-border/50">
                    {Array.from({ length: 5 }).map((_, idx) => (
                      <tr key={idx} className="hover:bg-brand-bg/30">
                        <td className="p-5">
                          <div className="h-4 w-40 rounded bg-brand-border/35" />
                        </td>
                        <td className="p-5">
