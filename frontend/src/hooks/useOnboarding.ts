  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const analysisPayload = {
      ...
      survey_answers: {
        ...
        // they can never be read as risk answers. The funds catalogue matches on
        // these; nothing else reads them. Horizon is stored as a target year so
        // it ages on its own rather than claiming five years forever.
        goals,
      },
