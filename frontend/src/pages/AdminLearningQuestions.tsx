  ...
  return (
    <div className="p-4 sm:p-6 lg:p-8 min-h-screen bg-brand-bg text-brand-fg">
      ...
      {isQuestionModalOpen ? (
        ...
        >
          <div
            className="flex max-h-[90dvh] w-full max-w-xl flex-col overflow-hidden rounded-3xl border border-brand-border/60 bg-brand-card shadow-2xl"
          ...
          >
            ...
            <form
              ...
              className="flex-1 overflow-y-auto overscroll-contain space-y-5 px-6 py-6"
            >
              {actionError ? (
      ...
      {isAnswerModalOpen && managedQuestion ? (
        ...
        >
          <div
            className="flex max-h-[90dvh] w-full max-w-4xl flex-col overflow-hidden rounded-3xl border border-brand-border/60 bg-brand-card shadow-2xl"
            onClick={(event) => event.stopPropagation()}
          >
            <div className="flex shrink-0 items-start justify-between gap-4 border-b border-brand-border/60 bg-brand-bg/70 px-6 py-5">
              <div className="space-y-2">
            ...
            <div className="flex-1 overflow-y-auto overscroll-contain grid gap-6 p-6 md:grid-cols-[320px_1fr]">
              <form
