    ...
    <div className="flex h-screen items-center justify-center bg-brand-bg p-4 flex-col">
      ...
      >
        <div className="text-center mb-2">
          <h1 className="text-3xl font-bold text-brand-fg tracking-tight">Welcome Back</h1>
          <p className="text-brand-muted-fg mt-2">Sign in to your AlphaSwarm account</p>
        </div>
        ...
        <p className="text-center text-sm text-brand-muted-fg mt-2">
          Don't have an account? <Link to="/signup" className="text-brand-primary hover:text-brand-primary-glow font-medium transition-colors">Sign Up</Link>
        </p>
      </form>
    </div>
  )
